...
function LlenaSolicitudes() {
    ...
    $.ajax({
        url: "../model/datagrid_atencion.php?cmb_whatsapp=" + cmb_whatsapp + "&cmb_reunion=" + cmb_reunion + "&cmb_pago=" + cmb_pago + "&cmb_profesional=" + cmb_profesional,
        method: "GET",
        dataType: "json",
...
function LlenaTabla() {
    ...
    $("#datatable").dataTable().fnReloadAjax("../model/datagrid_atencion.php?cmb_whatsapp=" + cmb_whatsapp + "&cmb_reunion=" + cmb_reunion + "&cmb_pago=" + cmb_pago + "&cmb_profesional=" + cmb_profesional);
